    ...
    try {
      ...
      <body>
        <div class="success">
          ...
          <div class="url">/artist/${finalSlug}</div>
          <a href="/artist/${finalSlug}" class="btn">View Artist</a>
