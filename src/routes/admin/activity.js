// ==================== ADMIN ACTIVITY PAGE (KV ONLY) ====================
import { getRecentActivity, getActivityByDate, getActivityByAction, formatActivityForDisplay } from '../../helpers/activityLog.js';
  ...
  const content = `
    <div style="margin-bottom: 20px;">
        ...
        <div style="display: flex; gap: 10px; margin-bottom: 20px; overflow-x: auto; padding: 5px 0;">
            ...
            <a href="/admin/activity?view=action&filter=create" class="tab-btn ${view === 'action' && filter === 'create' ? 'active' : ''}">
                <i class="fas fa-plus-circle"></i> Creates
            </a>
        </div>
                ...
                <div class="activity-item">
                    ...
                    <div class="activity-content">
                        ...
                        <div style="font-size: 0.7rem; color: #999; margin-top: 4px;">
                            ${new Date(log.raw.timestamp).toLocaleString()}
                        </div>
                    </div>
                </div>
            `).join('')}
