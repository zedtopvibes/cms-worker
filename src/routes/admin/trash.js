   ...
   <script>
    ...
    async function restoreItem(id) {
        if (confirm('Restore this item?')) {
            ...
            // Create progress bar - FIXED: Properly escaped
    ...
    async function emptyTrash(type) {
        if (confirm('⚠️ Permanently delete ALL items in trash? This cannot be undone.')) {
            ...
            // Create global progress bar - FIXED: Properly escaped
            ...
            if (!progressDiv) {
                ...
                progressDiv.innerHTML = '<div style=\"padding: 15px; background: #f8f9fa; border-radius: 8px;\">' +
